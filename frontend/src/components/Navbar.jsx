...
function Navbar() {
  ...
  const apiHandler = () => {
      axios.post("http://127.0.0.1:8000/login", { username: "yourUsername", password: "yourPassword" }).then(response => {
  ...
  const list = () => (
    ...
    >
      ...
      <List>
        ...
        <ListItem disablePadding selected={"/login" === location.pathname}>
          <ListItemButton href={"/login"} component={Button}>
            <ListItemText primary={"Admin?"} sx={{ textTransform: "none" }} />
          </ListItemButton>
        </ListItem>
      </List>
    </Box>
          ...
          <Toolbar disableGutters>
            ...
            >
              ...
              <Button
                ...
                sx={{
                  my: 2,
                  color: "/login" === location.pathname ? "#BA0C2F" : "#333",
                  display: "block",
